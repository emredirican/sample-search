...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityComponent objectGraph = ((SampleSearchApplication) getApplication()).getObjectGraph().plus(new ActivityModule(this));
    ...
    private void initSuggestionsList() {
        suggestionsAdapter = new ArrayAdapter<>(activityContext, R.layout.item_suggestion_result, new ArrayList<String>());
